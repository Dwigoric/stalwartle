...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			RESOLVER_MINMAX_MIN: (name, min, suffix) => `<:error:508595005481549846>  ::  \`${name}\` must be greater than ${min}${suffix}.`,
			RESOLVER_MINMAX_MAX: (name, max, suffix) => `<:error:508595005481549846>  ::  \`${name}\` must be less than ${max}${suffix}.`,
