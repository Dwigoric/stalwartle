...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        ...
        if (!moment.tz.zone(prompted.content)) throw `${this.container.client.constants.EMOTES.xmark}  ::  **${prompted.content}** is not a valid timezone!`;
        msg.author.settings.update('timezone', prompted.content);
        return msg.send(`${this.container.client.constants.EMOTES.tick}  ::  Your timezone has been changed to \`${prompted.content}\`.`);
    }
