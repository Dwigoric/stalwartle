...
module.exports = class extends Command {
	...
	async run(msg, [newPrefix]) {
		...
		if (!await msg.hasAtLeastPermissionLevel(6)) throw '<:crossmark:508590460688924693>  ::  Sorry! Only moderators or people with Manage Server permission may change the server prefix.'; // eslint-disable-line max-len
