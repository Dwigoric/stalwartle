...
module.exports = class extends Command {
    ...
    async messageRun(msg, [...role]) {
        ...
        return msg.send(`${this.container.constants.EMOTES.tick}  ::  Successfully set this server's mute role to **${newRole.name}**.`);
    }

    async reset(msg) {
        msg.guild.settings.reset('muteRole');
        return msg.send(`${this.container.constants.EMOTES.tick}  ::  Successfully reset this server's mute role.`);
    }
