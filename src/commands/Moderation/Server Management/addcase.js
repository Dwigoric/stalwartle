...
module.exports = class extends Command {
	...
	async kick(msg, [target, , ...reason]) {
		...
		return msg.send(`<:check:508594899117932544>  ::  Successfully added a kick case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
	...
	async ban(msg, [target, duration, ...reason]) {
		...
		return msg.send(`<:check:508594899117932544>  ::  Successfully added a ban case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
	...
	async unban(msg, [target, , ...reason]) {
		...
		this.client.emit('modlogAction', msg, target, reason);
		return msg.send(`<:check:508594899117932544>  ::  Successfully added an unban case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
	...
	async softban(msg, [target, , ...reason]) {
		...
		this.client.emit('modlogAction', msg, target, reason);
		return msg.send(`<:check:508594899117932544>  ::  Successfully added a softban case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
	...
	async mute(msg, [target, duration, ...reason]) {
		...
		this.client.emit('modlogAction', msg, target, reason, duration);
		return msg.send(`<:check:508594899117932544>  ::  Successfully added a mute case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
	...
	async unmute(msg, [target, , ...reason]) {
		...
		this.client.emit('modlogAction', msg, target, reason);
		return msg.send(`<:check:508594899117932544>  ::  Successfully added an unmute case for ${target.tag}! Check the modlogs via \`${msg.guild.settings.get('prefix')}modlogs\`.`);
	}
