...
module.exports = class extends Command {
	...
	async run(msg, [chan = msg.channel, question, ...choices]) {
		...
		if (!chan.permissionsFor(this.client.user).has(['EMBED_LINKS', 'ADD_REACTIONS'])) throw '<:error:508595005481549846>  ::  Please allow me to send embeds and/or give reactions in that channel.';
