...
module.exports = class extends Command {
	...
	async run(msg, [seek]) {
		...
		if (!queue.length || !msg.guild.me.voice.channelID || !msg.guild.player.playing) throw `<:error:508595005481549846>  ::  No song playing! Add one using \`${msg.guild.settings.get('prefix')}play\``; // eslint-disable-line max-len
