...
module.exports = class extends Command {
	...
	async run(msg) {
		...
		if (this.client.gateways.music.get(msg.guild.id, true).get('queue')[0].requester === this.client.user.id) this.client.gateways.music.get(msg.guild.id, true).update('queue', []);
