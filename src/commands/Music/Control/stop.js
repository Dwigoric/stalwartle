...
module.exports = class extends Command {
	...
	async run(msg) {
		...
		return msg.send(`<:check:508594899117932544>  ::  Successfully ended the music session for this server. Use \`${msg.guild.settings.get('prefix')}clear\` to clear the queue.`);
	}
