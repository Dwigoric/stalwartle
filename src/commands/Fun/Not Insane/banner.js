...
module.exports = class extends Command {
    ...
    async messageRun(msg, [banner]) {
        ...
        if (data.length > 2000) throw `${this.container.constants.EMOTES.xmark}  ::  The banner was too long! Please try making it shorter.`;
        if (!data) throw `${this.container.constants.EMOTES.xmark}  ::  Something went wrong! Did you supply a non-alphanumeric character?`;
