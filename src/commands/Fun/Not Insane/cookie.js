...
module.exports = class extends SubCommandPluginCommand {
    ...
    async default(msg, args) {
        ...
        if (cookieTask.length) return reply(msg, `${this.container.constants.EMOTES.xmark}  ::  You've just given someone a cookie! You can use it again in ${Duration.toNow(cookieTask[0].time)}.`);
