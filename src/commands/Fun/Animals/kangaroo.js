...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        const message = await reply(msg, `${this.container.constants.EMOTES.loading}  ::  Loading kangaroo...`);
        ...
        await reply(message, { files: [{ attachment: image, name: 'kangaroo.jpg' }], content: `Random kangaroo fact: ${fact}` });
