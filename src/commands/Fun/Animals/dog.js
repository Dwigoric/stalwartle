...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        const message = await send(msg, `${this.container.constants.EMOTES.loading}  ::  Loading dog...`);
        ...
        await send(message, { files: [{ attachment: image, name: 'dog.jpg' }], content: `Random dog fact: ${fact}` });
