...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        const message = await send(msg, `${this.container.constants.EMOTES.loading}  ::  Loading koala...`);
        ...
        await send(message, { files: [{ attachment: image, name: 'koala.jpg' }], content: `Random koala fact: ${fact}` });
