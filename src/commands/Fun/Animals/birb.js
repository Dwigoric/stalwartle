...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        const message = await send(msg, `${this.container.constants.EMOTES.loading}  ::  Loading birb...`);
        ...
        await send(message, { files: [{ attachment: image, name: 'birb.jpg' }], content: `Random birb fact: ${fact}` });
