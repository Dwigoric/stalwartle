...
module.exports = class extends Command {
    ...
    async messageRun(msg) {
        const message = await reply(msg, `${this.container.constants.EMOTES.loading}  ::  Loading birb...`);
        ...
        await reply(message, { files: [{ attachment: image, name: 'birb.jpg' }], content: `Random birb fact: ${fact}` });
