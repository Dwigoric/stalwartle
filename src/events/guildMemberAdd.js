...
module.exports = class extends Event {
	...
	async run(member) {
		...
		if ((autorole.bot || autorole.user) && !member.guild.me.permissions.has('MANAGE_ROLES')) return member.guild.owner.send(`⚠ I don't have **Manage Roles** permission on ${member.guild.name}, so I couldn't give ${member.user.tag} the autorole.`); // eslint-disable-line max-len
