...
module.exports = class extends Event {
    ...
    async run(message, user, reason, duration) {
        ...
        const { modlogs = [] } = await this.container.client.providers.default.get('modlogs', message.guild.id) || {};
        ...
        return this.container.client.providers.default.update('modlogs', message.guild.id, { modlogs }, true);
    }
