...
module.exports = class extends Event {
	...
	async run(message, user, reason, duration) {
		...
		const modlogs = this.client.gateways.modlogs.get(message.guild.id, true).get('modlogs');
		...
		return this.client.gateways.modlogs.get(message.guild.id, true).update('modlogs', modlogs);
	}
